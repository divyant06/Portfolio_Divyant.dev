;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="a87c8d06-2721-bfc2-3d53-6ca03ba6a131")}catch(e){}}();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$cobe$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/portfolio/node_modules/cobe/dist/index.esm.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
;
/* New Delhi coordinates */ const DELHI_LAT = 28.6139;
...
function CobeGlobe() {
    ...
    const pointerDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const pointerX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const phi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1.2);
    const globeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [visible, setVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const hasInitialized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const initGlobe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CobeGlobe.useCallback[initGlobe]": ()=>{
            ...
            try {
                globeRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$cobe$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(canvas, {
                    ...
                    onRender: {
                        "CobeGlobe.useCallback[initGlobe]": (state)=>{
                ...
                // If cobe fails, retry once after a delay
                setTimeout({
                    "CobeGlobe.useCallback[initGlobe]": ()=>{
                        try {
                            globeRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$cobe$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(canvas, {
                        ...
                        // Silent fail — no globe, but no crash
                        }
                    }
                }["CobeGlobe.useCallback[initGlobe]"], 2000);
            }
        }
    }["CobeGlobe.useCallback[initGlobe]"], []);
    /* Use IntersectionObserver to only init when in viewport.
     This gives the R3F torus context time to release GPU
     resources and ensures cobe gets a clean WebGL context. */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CobeGlobe.useEffect": ()=>{
            const container = containerRef.current;
            if (!container) return;
            const observer = new IntersectionObserver({
                "CobeGlobe.useEffect": (entries)=>{
                    if (entries[0].isIntersecting && !hasInitialized.current) {
                        // Delay slightly after becoming visible
            ...
            // Also set a fallback timer in case observer doesn't trigger
            const fallbackTimer = setTimeout({
                "CobeGlobe.useEffect.fallbackTimer": ()=>{
                    if (!hasInitialized.current) {
                        initGlobe();
                    }
                }
            }["CobeGlobe.useEffect.fallbackTimer"], 5000);
            const onResize = {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$portfolio$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CobeGlobe.useEffect": ()=>{
            ...
            if (!canvas) return;
            const onPointerDown = {
                "CobeGlobe.useEffect.onPointerDown": (e)=>{
                    pointerDown.current = true;
                    pointerX.current = e.clientX;
                }
            }["CobeGlobe.useEffect.onPointerDown"];
            const onPointerUp = {
                "CobeGlobe.useEffect.onPointerUp": ()=>{
                    pointerDown.current = false;
                }
            }["CobeGlobe.useEffect.onPointerUp"];
            const onPointerMove = {
                "CobeGlobe.useEffect.onPointerMove": (e)=>{
                    if (pointerDown.current) {
            ...
            }["CobeGlobe.useEffect.onPointerMove"];
...
_s(CobeGlobe, "NW0/7PsmFpKsMkKrvc+LYx9a/os=");
_c = CobeGlobe;
var _c;
...
//# debugId=a87c8d06-2721-bfc2-3d53-6ca03ba6a131
//# sourceMappingURL=portfolio_0zy86mr._.js.map